...
func TestEjemplo(t *testing.T) {
	...
	//parte3 tiene alguna función que debería implementarse o quedó de EasterEgg??
	...
	assert.Equal(t, float64(16), ensamble.ObtenerPrecio(), "El precio del ensamble debería ser 16")
