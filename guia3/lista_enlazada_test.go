...
func TestNewList(t *testing.T) {
	list := NuevaLista[int]()
	if list == nil {
		t.Error("NuevaLista() devolvió nil")
	}
	if list.Size() != 0 {
...
func TestAppend(t *testing.T) {
	...
	list.Append(1)
	if list.Size() != 1 {
		t.Error("El tamaño de la lista debería ser 1 y es ", list.Size())
	}
	if list.Head().Data() != 1 {
		t.Error("El dato del primer nodo debería ser 1 y es ", list.Head().Data())
	}
	if list.Tail().Data() != 1 {
		t.Error("El dato del último nodo debería ser 1 y es ", list.Tail().Data())
	}
	list.Append(2)
	if list.Size() != 2 {
		t.Error("El tamaño de la lista debería ser 2 y es ", list.Size())
	}
	if list.Head().Data() != 1 {
		t.Error("El dato del primer nodo debería ser 1 y es ", list.Head().Data())
	}
	if list.Tail().Data() != 2 {
		t.Error("El dato del último nodo debería ser 2 y es ", list.Tail().Data())
	}
}
